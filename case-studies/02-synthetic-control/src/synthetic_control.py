...
def in_space_placebo(
    ...
    """
    Run placebo-in-space: re-fit SC pretending each unit is the treated unit.

    Returns a dict {unit_name: result} for every unit (the real treated unit
    and every donor). The empirical p-value for the real effect is:
