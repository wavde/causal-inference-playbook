...
For a confidence interval on the point estimate (rather than just a p-value), the principled choice for SC is Chernozhukov, Wüthrich & Zhu (2021) conformal inference; the placebo permutation shipped above is the textbook approach for a hypothesis test and is what we rely on here.
